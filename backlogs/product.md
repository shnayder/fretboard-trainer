...
## Active
- Product vision is thin — the [NEEDS INPUT] placeholder needs real content:
  who is this for, what does mastery look like, what's the end state
- No tone/personality guidance — covers UI language, imagery feel, etc.
- No UX glossary — mode, quiz, round, item, fluent vs mastered, recall vs speed
- Roadmap fragmentation — vision.md, ideas.md, backlog overlap. Consolidate.
- Landing screen — follow up from claude/redesign-navigation-menu-xpSD4
